...
exports.RebalanceTakeProfitState = void 0;
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const borsh = __importStar(require("@coral-xyz/borsh"));
class RebalanceTakeProfitState {
    step;
    constructor(fields) {
        this.step = fields.step;
    }
    static layout(property) {
        return borsh.struct([types.RebalanceTakeProfitStep.layout("step")], property);
    }
...
exports.RebalanceTakeProfitState = RebalanceTakeProfitState;
