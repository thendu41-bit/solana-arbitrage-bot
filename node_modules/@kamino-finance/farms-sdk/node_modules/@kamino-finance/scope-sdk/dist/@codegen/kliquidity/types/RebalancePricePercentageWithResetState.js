...
exports.RebalancePricePercentageWithResetState = void 0;
const bn_js_1 = __importDefault(require("bn.js")); // eslint-disable-line @typescript-eslint/no-unused-vars
const borsh = __importStar(require("@coral-xyz/borsh"));
class RebalancePricePercentageWithResetState {
    ...
    toJSON() {
        return {
            lastRebalanceLowerResetPoolPrice: this.lastRebalanceLowerResetPoolPrice.toString(),
            lastRebalanceUpperResetPoolPrice: this.lastRebalanceUpperResetPoolPrice.toString(),
        };
    }
    static fromJSON(obj) {
        return new RebalancePricePercentageWithResetState({
            lastRebalanceLowerResetPoolPrice: new bn_js_1.default(obj.lastRebalanceLowerResetPoolPrice),
            lastRebalanceUpperResetPoolPrice: new bn_js_1.default(obj.lastRebalanceUpperResetPoolPrice),
        });
    }
    toEncodable() {
...
exports.RebalancePricePercentageWithResetState = RebalancePricePercentageWithResetState;
//# sourceMappingURL=RebalancePricePercentageWithResetState.js.map