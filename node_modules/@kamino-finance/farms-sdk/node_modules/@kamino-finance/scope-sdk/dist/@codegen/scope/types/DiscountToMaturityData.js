...
exports.DiscountToMaturityData = void 0;
...
class DiscountToMaturityData {
    ...
    static layout(property) {
        return borsh.struct([borsh.u16("discountPerYearBps"), borsh.i64("maturityTimestamp")], property);
    }
    ...
    static fromJSON(obj) {
        return new DiscountToMaturityData({
            discountPerYearBps: obj.discountPerYearBps,
            maturityTimestamp: new bn_js_1.default(obj.maturityTimestamp),
        });
    }
    toEncodable() {
...
exports.DiscountToMaturityData = DiscountToMaturityData;
//# sourceMappingURL=DiscountToMaturityData.js.map