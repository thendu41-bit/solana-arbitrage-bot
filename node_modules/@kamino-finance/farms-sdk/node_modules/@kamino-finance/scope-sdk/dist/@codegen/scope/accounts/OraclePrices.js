...
class OraclePrices {
    ...
    static decode(data) {
        ...
        return new OraclePrices({
            ...
            prices: dec.prices.map((item /* eslint-disable-line @typescript-eslint/no-explicit-any */) => types.DatedPrice.fromDecoded(item)),
        });
    }
    toJSON() {
        return {
...
exports.OraclePrices = OraclePrices;
