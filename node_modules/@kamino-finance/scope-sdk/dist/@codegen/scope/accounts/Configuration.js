...
class Configuration {
    ...
    static layout = borsh.struct([
        ...
        (0, utils_1.borshAddress)("oracleMappings"),
        (0, utils_1.borshAddress)("oraclePrices"),
        (0, utils_1.borshAddress)("tokensMetadata"),
        (0, utils_1.borshAddress)("oracleTwaps"),
        (0, utils_1.borshAddress)("adminCached"),
    ...
    static fromJSON(obj) {
        return new Configuration({
            ...
            oracleMappings: (0, kit_1.address)(obj.oracleMappings),
            oraclePrices: (0, kit_1.address)(obj.oraclePrices),
            tokensMetadata: (0, kit_1.address)(obj.tokensMetadata),
            oracleTwaps: (0, kit_1.address)(obj.oracleTwaps),
            adminCached: (0, kit_1.address)(obj.adminCached),
