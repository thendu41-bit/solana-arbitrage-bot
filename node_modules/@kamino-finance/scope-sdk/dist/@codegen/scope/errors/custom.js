...
exports.CappedFlooredBothCapAndFloorAreNone = exports.CompositeOracleInvalidSourceIndex = exports.WrongAccountOwner = exports.ExpectedPriceAccount = exports.PythLazerInvalidAskBidPrices = exports.PythLazerBestAskPriceNotPresent = void 0;
...
class ExpectedPriceAccount extends Error {
    logs;
    static code = 6052;
    code = 6052;
    name = "ExpectedPriceAccount";
...
exports.ExpectedPriceAccount = ExpectedPriceAccount;
class WrongAccountOwner extends Error {
    logs;
    static code = 6053;
    code = 6053;
...
exports.WrongAccountOwner = WrongAccountOwner;
class CompositeOracleInvalidSourceIndex extends Error {
    logs;
    static code = 6054;
    code = 6054;
    name = "CompositeOracleInvalidSourceIndex";
...
exports.CompositeOracleInvalidSourceIndex = CompositeOracleInvalidSourceIndex;
class CappedFlooredBothCapAndFloorAreNone extends Error {
    logs;
    static code = 6055;
    code = 6055;
    name = "CappedFlooredBothCapAndFloorAreNone";
...
exports.CappedFlooredBothCapAndFloorAreNone = CappedFlooredBothCapAndFloorAreNone;
