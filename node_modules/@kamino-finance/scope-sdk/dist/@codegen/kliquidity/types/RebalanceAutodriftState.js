...
exports.RebalanceAutodriftState = void 0;
const types = __importStar(require("../types")); // eslint-disable-line @typescript-eslint/no-unused-vars
const borsh = __importStar(require("@coral-xyz/borsh"));
class RebalanceAutodriftState {
    lastWindow;
    currentWindow;
    step;
    constructor(fields) {
    ...
    static fromDecoded(obj) {
        return new RebalanceAutodriftState({
            ...
            currentWindow: types.RebalanceAutodriftWindow.fromDecoded(obj.currentWindow),
    ...
    static toEncodable(fields) {
        return {
            ...
            currentWindow: types.RebalanceAutodriftWindow.toEncodable(fields.currentWindow),
...
exports.RebalanceAutodriftState = RebalanceAutodriftState;
