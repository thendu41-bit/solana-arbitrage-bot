...
class ObservationState {
    ...
    static async fetch(rpc, address, programId = programId_1.PROGRAM_ID) {
        ...
        if (info.programAddress !== programId) {
            throw new Error(`ObservationStateFields account ${address} belongs to wrong program ${info.programAddress}, expected ${programId}`);
        }
    ...
    static async fetchMultiple(rpc, addresses, programId = programId_1.PROGRAM_ID) {
        ...
        return infos.map((info) => {
            ...
            if (info.programAddress !== programId) {
                throw new Error(`ObservationStateFields account ${info.address} belongs to wrong program ${info.programAddress}, expected ${programId}`);
            }
            return this.decode(Buffer.from(info.data));
        });
    }
    static decode(data) {
        ...
        return new ObservationState({
            ...
            poolId: dec.poolId,
            observations: dec.observations.map((item /* eslint-disable-line @typescript-eslint/no-explicit-any */) => types.Observation.fromDecoded(item)),
            padding: dec.padding,
        });
    }
    toJSON() {
...
exports.ObservationState = ObservationState;
//# sourceMappingURL=ObservationState.js.map