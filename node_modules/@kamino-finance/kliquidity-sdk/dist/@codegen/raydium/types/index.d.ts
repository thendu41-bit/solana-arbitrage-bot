...
export type PoolStatusBitIndexKind = PoolStatusBitIndex.OpenPositionOrIncreaseLiquidity | PoolStatusBitIndex.DecreaseLiquidity | PoolStatusBitIndex.CollectFee | PoolStatusBitIndex.CollectReward | PoolStatusBitIndex.Swap;
export type PoolStatusBitIndexJSON = PoolStatusBitIndex.OpenPositionOrIncreaseLiquidityJSON | PoolStatusBitIndex.DecreaseLiquidityJSON | PoolStatusBitIndex.CollectFeeJSON | PoolStatusBitIndex.CollectRewardJSON | PoolStatusBitIndex.SwapJSON;
...
export { RewardState };
export type RewardStateKind = RewardState.Uninitialized | RewardState.Initialized | RewardState.Opening | RewardState.Ended;
export type RewardStateJSON = RewardState.UninitializedJSON | RewardState.InitializedJSON | RewardState.OpeningJSON | RewardState.EndedJSON;
