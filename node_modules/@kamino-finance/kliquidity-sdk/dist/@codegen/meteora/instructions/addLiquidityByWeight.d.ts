...
export declare const layout: import("buffer-layout").Layout<AddLiquidityByWeightArgs>;
export declare function addLiquidityByWeight(args: AddLiquidityByWeightArgs, accounts: AddLiquidityByWeightAccounts, remainingAccounts?: Array<IAccountMeta | IAccountSignerMeta>, programAddress?: Address): IInstruction;
