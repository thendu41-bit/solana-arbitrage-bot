...
exports.addLiquidityByStrategyOneSide = addLiquidityByStrategyOneSide;
...
function addLiquidityByStrategyOneSide(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        { address: accounts.position, role: 1 },
        { address: accounts.lbPair, role: 1 },
        (0, kit_1.isSome)(accounts.binArrayBitmapExtension)
    ...
    const len = exports.layout.encode({
        liquidityParameter: types.LiquidityParameterByStrategyOneSide.toEncodable(args.liquidityParameter),
    }, buffer);
    const data = Buffer.concat([identifier, buffer]).slice(0, 8 + len);
    const ix = { accounts: keys, programAddress, data };
    return ix;
}
//# sourceMappingURL=addLiquidityByStrategyOneSide.js.map