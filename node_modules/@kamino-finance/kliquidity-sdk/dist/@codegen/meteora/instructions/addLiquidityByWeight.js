...
exports.addLiquidityByWeight = addLiquidityByWeight;
...
function addLiquidityByWeight(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
    ...
    const len = exports.layout.encode({
        liquidityParameter: types.LiquidityParameterByWeight.toEncodable(args.liquidityParameter),
    }, buffer);
    const data = Buffer.concat([identifier, buffer]).slice(0, 8 + len);
    const ix = { accounts: keys, programAddress, data };
    return ix;
}
//# sourceMappingURL=addLiquidityByWeight.js.map