...
exports.goToABin = goToABin;
/* eslint-disable @typescript-eslint/no-unused-vars */
const kit_1 = require("@solana/kit");
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.layout = borsh.struct([borsh.i32("binId")]);
function goToABin(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        ...
        (0, kit_1.isSome)(accounts.fromBinArray)
            ? { address: accounts.fromBinArray.value, role: 0 }
            : { address: programAddress, role: 0 },
        (0, kit_1.isSome)(accounts.toBinArray)
