...
exports.addLiquidityOneSidePrecise = addLiquidityOneSidePrecise;
...
function addLiquidityOneSidePrecise(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
    ...
    const len = exports.layout.encode({
        parameter: types.AddLiquiditySingleSidePreciseParameter.toEncodable(args.parameter),
    }, buffer);
