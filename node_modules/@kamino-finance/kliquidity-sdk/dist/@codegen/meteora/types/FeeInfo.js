...
class FeeInfo {
    ...
    static fromJSON(obj) {
        return new FeeInfo({
            feeXPerTokenComplete: new bn_js_1.default(obj.feeXPerTokenComplete),
            feeYPerTokenComplete: new bn_js_1.default(obj.feeYPerTokenComplete),
            feeXPending: new bn_js_1.default(obj.feeXPending),
            feeYPending: new bn_js_1.default(obj.feeYPending),
        });
    }
    toEncodable() {
