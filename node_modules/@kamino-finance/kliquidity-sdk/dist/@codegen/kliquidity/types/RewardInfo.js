...
class RewardInfo {
    ...
    static fromJSON(obj) {
        return new RewardInfo({
            ...
            emissionsPerSecondX64: new bn_js_1.default(obj.emissionsPerSecondX64),
            rewardTotalEmissioned: new bn_js_1.default(obj.rewardTotalEmissioned),
            rewardClaimed: new bn_js_1.default(obj.rewardClaimed),
            tokenMint: (0, kit_1.address)(obj.tokenMint),
            tokenVault: (0, kit_1.address)(obj.tokenVault),
            authority: (0, kit_1.address)(obj.authority),
            rewardGrowthGlobalX64: new bn_js_1.default(obj.rewardGrowthGlobalX64),
        });
    }
    toEncodable() {
