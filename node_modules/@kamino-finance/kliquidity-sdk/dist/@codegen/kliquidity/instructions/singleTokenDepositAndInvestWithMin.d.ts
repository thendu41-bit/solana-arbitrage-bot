...
export declare const layout: import("buffer-layout").Layout<SingleTokenDepositAndInvestWithMinArgs>;
export declare function singleTokenDepositAndInvestWithMin(args: SingleTokenDepositAndInvestWithMinArgs, accounts: SingleTokenDepositAndInvestWithMinAccounts, remainingAccounts?: Array<IAccountMeta | IAccountSignerMeta>, programAddress?: Address): IInstruction;
