...
exports.ProtocolPositionState = void 0;
...
class ProtocolPositionState {
    ...
    static async fetch(rpc, address, programId = programId_1.PROGRAM_ID) {
        ...
        if (info.programAddress !== programId) {
            throw new Error(`ProtocolPositionStateFields account ${address} belongs to wrong program ${info.programAddress}, expected ${programId}`);
        }
    ...
    static async fetchMultiple(rpc, addresses, programId = programId_1.PROGRAM_ID) {
        ...
        return infos.map((info) => {
            ...
            if (info.programAddress !== programId) {
                throw new Error(`ProtocolPositionStateFields account ${info.address} belongs to wrong program ${info.programAddress}, expected ${programId}`);
            }
            return this.decode(Buffer.from(info.data));
        });
    }
    ...
    static fromJSON(obj) {
        return new ProtocolPositionState({
            ...
            rewardGrowthInside: obj.rewardGrowthInside.map((item) => new bn_js_1.default(item)),
            padding: obj.padding.map((item) => new bn_js_1.default(item)),
        });
    }
}
exports.ProtocolPositionState = ProtocolPositionState;
//# sourceMappingURL=ProtocolPositionState.js.map