...
exports.WhirlpoolsConfig = void 0;
...
class WhirlpoolsConfig {
    ...
    static layout = borsh.struct([
        (0, utils_1.borshAddress)("feeAuthority"),
        (0, utils_1.borshAddress)("collectProtocolFeesAuthority"),
        (0, utils_1.borshAddress)("rewardEmissionsSuperAuthority"),
    ...
    static async fetch(rpc, address, programId = programId_1.PROGRAM_ID) {
        ...
        if (info.programAddress !== programId) {
            throw new Error(`WhirlpoolsConfigFields account ${address} belongs to wrong program ${info.programAddress}, expected ${programId}`);
        }
    ...
    static async fetchMultiple(rpc, addresses, programId = programId_1.PROGRAM_ID) {
        ...
        return infos.map((info) => {
            ...
            if (info.programAddress !== programId) {
                throw new Error(`WhirlpoolsConfigFields account ${info.address} belongs to wrong program ${info.programAddress}, expected ${programId}`);
            }
            return this.decode(Buffer.from(info.data));
        });
    }
    ...
    static fromJSON(obj) {
        return new WhirlpoolsConfig({
            feeAuthority: (0, kit_1.address)(obj.feeAuthority),
            collectProtocolFeesAuthority: (0, kit_1.address)(obj.collectProtocolFeesAuthority),
            rewardEmissionsSuperAuthority: (0, kit_1.address)(obj.rewardEmissionsSuperAuthority),
            defaultProtocolFeeRate: obj.defaultProtocolFeeRate,
        });
    }
}
exports.WhirlpoolsConfig = WhirlpoolsConfig;
//# sourceMappingURL=WhirlpoolsConfig.js.map