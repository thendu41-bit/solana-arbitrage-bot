...
class PositionBundle {
    ...
    static layout = borsh.struct([
        (0, utils_1.borshAddress)("positionBundleMint"),
    ...
    static async fetch(rpc, address, programId = programId_1.PROGRAM_ID) {
        ...
        if (info.programAddress !== programId) {
            throw new Error(`PositionBundleFields account ${address} belongs to wrong program ${info.programAddress}, expected ${programId}`);
        }
    ...
    static async fetchMultiple(rpc, addresses, programId = programId_1.PROGRAM_ID) {
        ...
        return infos.map((info) => {
            ...
            if (info.programAddress !== programId) {
                throw new Error(`PositionBundleFields account ${info.address} belongs to wrong program ${info.programAddress}, expected ${programId}`);
            }
            return this.decode(Buffer.from(info.data));
        });
    }
    ...
    static fromJSON(obj) {
        return new PositionBundle({
            positionBundleMint: (0, kit_1.address)(obj.positionBundleMint),
            positionBitmap: obj.positionBitmap,
        });
    }
}
exports.PositionBundle = PositionBundle;
//# sourceMappingURL=PositionBundle.js.map