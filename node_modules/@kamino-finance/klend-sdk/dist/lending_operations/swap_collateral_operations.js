...
async function getSwapCollIxs(inputs) {
    ...
    const scopeRefreshIx = await (0, leverage_1.getScopeRefreshIx)(context.market, context.sourceCollReserve, context.targetCollReserve, context.obligation, context.scopeRefreshConfig);
