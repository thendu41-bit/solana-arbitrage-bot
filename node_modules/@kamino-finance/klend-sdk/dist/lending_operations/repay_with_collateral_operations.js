...
async function getRepayWithCollSwapInputs({ collTokenMint, currentSlot, debtTokenMint, kaminoMarket, owner, obligation, quoter, referrer, repayAmount, isClosingPosition, budgetAndPriorityFeeIxs, scopeRefreshConfig, useV2Ixs, }) {
    ...
    const klendIxs = (await buildRepayWithCollateralIxs(kaminoMarket, debtReserve, collReserve, owner, obligation, referrer, currentSlot, budgetAndPriorityFeeIxs, scopeRefreshConfig, [
        {
            preActionIxs: [],
            swapIxs: [],
            lookupTables: [],
...
async function getRepayWithCollIxs({ repayAmount, isClosingPosition, budgetAndPriorityFeeIxs, collTokenMint, currentSlot, debtTokenMint, kaminoMarket, owner, obligation, quoter, swapper, referrer, scopeRefreshConfig, useV2Ixs, logger = console.log, }) {
    ...
    const repayWithCollateralIxs = await buildRepayWithCollateralIxs(kaminoMarket, debtReserve, collReserve, owner, obligation, referrer, currentSlot, budgetAndPriorityFeeIxs, scopeRefreshConfig, swapResponses, isClosingPosition, debtRepayAmountLamports, swapInputs.inputAmountLamports, useV2Ixs);
...
async function buildRepayWithCollateralIxs(market, debtReserve, collReserve, owner, obligation, referrer, currentSlot, budgetAndPriorityFeeIxs, scopeRefreshConfig, swapQuoteIxsArray, isClosingPosition, debtRepayAmountLamports, collWithdrawLamports, useV2Ixs) {
    ...
    const scopeRefreshIx = await (0, leverage_1.getScopeRefreshIx)(market, collReserve, debtReserve, obligation, scopeRefreshConfig);
