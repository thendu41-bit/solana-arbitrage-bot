...
async function withdraw(env, mode, token, depositAmount) {
    ...
    const kaminoAction = await classes_1.KaminoAction.buildWithdrawTxns(kaminoMarket, depositAmount, kaminoMarket.getReserveBySymbol(token).getLiquidityMint(), signer, new utils_1.VanillaObligation(market_1.STAGING_LENDING_MARKET), true, { scope, scopeConfigurations: await scope.getAllConfigurations() });
