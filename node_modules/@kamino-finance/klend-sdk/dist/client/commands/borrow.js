...
async function borrow(env, mode, token, borrowAmount) {
    ...
    const kaminoAction = await classes_1.KaminoAction.buildBorrowTxns(kaminoMarket, borrowAmount, kaminoMarket.getReserveBySymbol(token).getLiquidityMint(), signer, new utils_1.VanillaObligation(market_1.STAGING_LENDING_MARKET), true, { scope, scopeConfigurations: await scope.getAllConfigurations() });
