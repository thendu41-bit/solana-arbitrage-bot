...
class KaminoManager {
    ...
    async getAllMarkets(programId = programId_1.PROGRAM_ID) {
        ...
        const combinedMarkets = lendingMarketPairs.map(([pubkey, market]) => {
            ...
            return lib_1.KaminoMarket.loadWithReserves(this.getRpc(), market, reservesByAddress, pubkey, slotDuration);
        });
    ...
    async getAllVaultsForOwner(owner) {
        ...
        return kaminoVaults.map((kaminoVault) => {
            ...
            return new vault_1.KaminoVault(kaminoVault.address, kaminoVaultAccount, this._kaminoVaultProgramId);
        });
    }
    /**
     ...
     */
    async getReserveFarmRewardsAPY(reserve, reserveTokenPrice, farmsClient, slot, reserveState, cTokenMintDecimals) {
        return (0, farmUtils_1.getReserveFarmRewardsAPY)(this._rpc, this.recentSlotDurationMs, reserve, reserveTokenPrice, this._kaminoLendProgramId, farmsClient ? farmsClient : new dist_1.Farms(this._rpc), slot ? slot : await this.getRpc().getSlot().send(), reserveState, cTokenMintDecimals);
    }
    /**
     ...
     * @returns a hashmap from each reserve pubkey to the reserve state
     */
    async loadVaultsReserves(vaults) {
     ...
     */
    async investAllReservesIxs(payer, kaminoVault) {
