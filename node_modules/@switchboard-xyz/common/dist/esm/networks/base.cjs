...
exports.SWITCHBOARD_BASE_CONFIG = exports.SWITCHBOARD_BASE_TESTNET_CONFIG = exports.SWITCHBOARD_BASE_MAINNET_CONFIG = void 0;
exports.SWITCHBOARD_BASE_MAINNET_CONFIG = {
    chain: 'base',
    chainId: 8453,
    networkName: 'Mainnet',
    address: '',
...
exports.SWITCHBOARD_BASE_TESTNET_CONFIG = {
    chain: 'base',
    chainId: 84531,
    networkName: 'Goerli',
...
```
 */
exports.SWITCHBOARD_BASE_CONFIG = {
    mainnet: exports.SWITCHBOARD_BASE_MAINNET_CONFIG,
    testnet: exports.SWITCHBOARD_BASE_TESTNET_CONFIG,
};
