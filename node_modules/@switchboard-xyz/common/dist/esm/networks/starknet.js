export const SWITCHBOARD_STARKNET_GOERLI_CONFIG = {
    chain: 'starknet',
    networkName: 'Goerli',
...
export const SWITCHBOARD_STARKNET_SEPOLIA_CONFIG = {
    chain: 'starknet',
    networkName: 'Sepolia',
    address: '',
    metadata: {
...
export const SWITCHBOARD_STARKNET_MAINNET_CONFIG = {
    chain: 'starknet',
    networkName: 'Mainnet',
...
export const SWITCHBOARD_STARKNET_CONFIG = {
