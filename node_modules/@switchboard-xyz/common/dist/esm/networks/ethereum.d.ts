...
export declare const SWITCHBOARD_ETHEREUM_MAINNET_CONFIG: IEvmNetworkConfig;
export declare const SWITCHBOARD_ETHEREUM_TESTNET_CONFIG: IEvmNetworkConfig;
/**
...
```
 */
export declare const SWITCHBOARD_ETHEREUM_CONFIG: IChainConfig;
