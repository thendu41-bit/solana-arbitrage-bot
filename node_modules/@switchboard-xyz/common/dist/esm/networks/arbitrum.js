export const SWITCHBOARD_ARBITRUM_MAINNET_CONFIG = {
    chain: 'arbitrum',
    chainId: 42161,
    networkName: 'Mainnet',
...
export const SWITCHBOARD_ARBITRUM_TESTNET_CONFIG = {
    chain: 'arbitrum',
    chainId: 421613,
    networkName: 'Goerli',
...
export const SWITCHBOARD_ARBITRUM_SEPOLIA_CONFIG = {
    chain: 'arbitrum',
    chainId: 421614,
    networkName: 'Sepolia',
...
```
 */
export const SWITCHBOARD_ARBITRUM_CONFIG = {
