...
exports.SWITCHBOARD_SUI_CONFIG = exports.SWITCHBOARD_SUI_TESTNET_CONFIG = exports.SWITCHBOARD_SUI_MAINNET_CONFIG = void 0;
exports.SWITCHBOARD_SUI_MAINNET_CONFIG = {
    chain: 'sui',
    networkName: 'Mainnet',
...
exports.SWITCHBOARD_SUI_TESTNET_CONFIG = {
    chain: 'sui',
    networkName: 'Testnet',
...
```
 */
exports.SWITCHBOARD_SUI_CONFIG = {
    mainnet: exports.SWITCHBOARD_SUI_MAINNET_CONFIG,
    testnet: exports.SWITCHBOARD_SUI_TESTNET_CONFIG,
};
