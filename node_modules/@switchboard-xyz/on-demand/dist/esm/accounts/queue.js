...
export class Queue {
    ...
    fetchFreshOracle() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < oracles.length; i++) {
                try {
                    // Test gateways to see if they are good. Timeout after 2 seconds.
                    const isGood = yield AsyncUtils.promiseWithTimeout(4000, tests[i]);
                    if (!isGood)
                        continue;
                }
                catch (_a) {
    ...
    fetchQuoteIx(crossbar, feedHashesOrFeeds, configs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ed25519Instruction = Ed25519InstructionUtils.buildEd25519Instruction(ed25519Signatures, (_b = config.instructionIdx) !== null && _b !== void 0 ? _b : 0, typeof response.slot === 'number'
                ? response.slot
