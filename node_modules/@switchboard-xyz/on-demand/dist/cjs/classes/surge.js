...
class SurgeUpdate {
    ...
    toBundleIx(instructionIdx = 0) {
        ...
        if (response.oracle_response.ed25519_enclave_signer) {
            ...
            const ed25519Instruction = Ed25519InstructionUtils_js_1.Ed25519InstructionUtils.buildEd25519Instruction([ed25519Signature], instructionIdx, response.oracle_response.slot, // recent_slot from oracle response
            ...
            const secpInstruction = Secp256k1InstructionUtils_js_1.Secp256k1InstructionUtils.buildSecp256k1Instruction(secpSignatures, instructionIdx);
...
class Surge extends events_1.EventEmitter {
    ...
    attemptSessionRequest(attempt, maxRetries, feedHints) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield axios_1.default.post(requestUrl, requestBody, {
                headers: {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const feed of feeds) {
                if ('feedHash' in feed) {
                    ...
                    processedFeeds.push({
                        symbol: feed.symbol,
                        source: feed.source || source_js_1.Source.WEIGHTED, // Default to weighted average
                    });
                }
            }
            ...
            try {
                ...
                for (const feed of feeds) {
                    if ('symbol' in feed) {
                        ...
                        this.log(`✅ Validated: ${feed.symbol} ${feed.source ? `(${source_js_1.Source.toString(feed.source)})` : ''}`);
                    }
                }
            }
            catch (error) {
