...
export class Queue {
    ...
    fetchUpdateBundleIx(gateway_1, crossbar_1, feedHashes_1) {
        return __awaiter(this, arguments, void 0, function* (gateway, crossbar, feedHashes, numSignatures = 1, instructionIdx = 0) {
            ...
            const ed25519Instruction = Ed25519InstructionUtils.buildEd25519Instruction(ed25519Signatures, instructionIdx, typeof response.slot === 'number'
                ? response.slot
